...
const getGrammarReviews = (grammarId: number) => {
  return userReviewsStore.userReviewGrammars.filter(userReviewGrammar =>
    userReviewGrammar.grammar_id === grammarId &&
    userReviewGrammar.course.slug === route.params.slug &&
    userReviewGrammar.course_level_grammar.position === parseInt(route.params.position as string)
  )
}
...
async function fetchData() {
  ...
  await courseLevelsStore.fetchCourseLevel(route.params.slug as string, 'grammar', position.value)
